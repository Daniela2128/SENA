...
public class ControladorPrograma extends HttpServlet {
   ...
   int id;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            int codp = Integer.parseInt(request.getParameter("txtcodprograma"));
            ...
            {
             id = Integer.parseInt(request.getParameter("txtidpro"));
            int Codprograma = Integer.parseInt(request.getParameter("txtcodprograma"));
            String nombrepro=request.getParameter("txtnombrepro");
