...
public class ControladorPrograma extends HttpServlet {
    ...
    String agregarp ="vista/Fprograma.jsp";
    String editarp="vista/Feditarpro.jsp";
    String listarp="vista/Flistarpro.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombrep= request.getParameter("txtnombrepro");
        po.setCodprograma(codp);
        po.setnombrepro(nombrep);
