                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-danger" href="../ControladorPrograma?accion=editar%id=<%=usu.getid()%>">Editar</a>
                            <a class="btn btn-warning" href="../ControladorPrograms?accion=eliminar&id=<%=usu.getid()%>">Eliminar</a>
